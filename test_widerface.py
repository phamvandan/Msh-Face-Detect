...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_folder', default='../widerface/val', type=str, help='dataset path')
    parser.add_argument('--folder_pict', default='../widerface/', type=str, help='folder_pict')
